...
import { ArrowRight, BookOpen, FileSpreadsheet, GraduationCap, ShieldAlert, ShieldCheck, Upload, Users, Warehouse } from "lucide-react";
...
const areas = [
  ...
  { href: "/exam-planning/course-loads", label: "Course loads", text: "Primary aggregate workflow for programme, level, course, and candidates.", icon: FileSpreadsheet },
  { href: "/exam-planning/conflicts", label: "Aggregate conflicts", text: "Cohort-aware readiness, explicit restrictions, and conflict inspection.", icon: ShieldAlert },
