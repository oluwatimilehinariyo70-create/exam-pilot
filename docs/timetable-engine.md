# Legacy timetable engine

This document describes the registration/course engine retained for backward compatibility. Phase E adds the separate [aggregate fixed-session engine](aggregate-timetable-engine.md) for `ExamEvent` scheduling.
